...
class ConfigText extends ConfigGeneric {
    ...
    renderItem(error, disabled) {
        ...
        if (this.props.schema.time) {
            ...
            return (React.createElement(TextField, { variant: "standard", fullWidth: true, value: time, error: !!error || !!this.state.jsonError, disabled: !!disabled, slotProps: {
                    htmlInput: {
                        readOnly: true,
                    },
        ...
        if (isIndeterminate) {
            ...
            return (React.createElement(Autocomplete, { style: styles.indeterminate, fullWidth: true, value: arr[0], 
                ...
                }, options: arr, getOptionLabel: option => option.label, renderInput: params => (React.createElement(TextField, { variant: "standard", ...params, error: !!error, placeholder: this.getText(this.props.schema.placeholder), slotProps: {
                        htmlInput: {
                            ...params.inputProps,
        ...
        if ((this.props.schema.readOnly || disabled) && this.props.schema.copyToClipboard) {
            ...
            actionButton = (React.createElement(IconButton, { style: actionButtonStyle, size: "small", tabIndex: -1, onClick: () => this.setState({ value: '', oldValue: this.state.value }, () => this.onChange(this.props.attr, '')) },
                React.createElement(CloseIcon, null)));
            if (this.props.schema.minRows <= 1) {
                actionButton = React.createElement(InputAdornment, { position: "end" }, actionButton);
            }
        }
        if (this.props.schema.minRows > 1) {
            ...
            return (React.createElement("div", { style: { width: '100%', position: 'relative' } },
                this.props.schema.label ? (React.createElement("div", { style: styles.label }, this.getText(this.props.schema.label))) : null,
