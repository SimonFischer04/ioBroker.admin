...
class ConfigInterface extends ConfigGeneric {
    ...
    renderItem(error, disabled /* , defaultValue */) {
        ...
        return (React.createElement(FormControl, { fullWidth: true, variant: "standard" },
            ...
            !this.state.interfaces?.length ? (React.createElement(TextField, { fullWidth: true, variant: "standard", error: !!error, disabled: !!disabled, value: value, onChange: e => this.onChange(this.props.attr, e.target.value), label: this.getText(this.props.schema.label) })) : (React.createElement(Select, { variant: "standard", error: !!error, disabled: !!disabled, value: value, renderValue: val => {
                    if (item) {
