...
import { Refresh as IconRefresh, UploadFile as IconUpload, Delete as IconDelete, PlayArrow as IconPlay, MusicNote as IconAudio, Videocam as IconVideo, Article as IconText, Code as IconCode, UploadFile as UploadIcon, } from '@mui/icons-material';
...
class ConfigFileSelector extends ConfigGeneric {
    ...
    renderDeleteDialog() {
        ...
        return (React.createElement(DialogConfirm, { title: I18n.t('ra_Are you sure?'), text: I18n.t('ra_File will be deleted'), ok: I18n.t('ra_Delete'), cancel: I18n.t('ra_Cancel'), onClose: isOk => {
    ...
    renderItem(error, disabled /* , defaultValue */) {
        ...
        const element = (React.createElement("div", { style: styles.fullWidth },
            React.createElement(FormControl, { variant: "standard", style: { width: `calc(100% - ${buttons * 42}px)` } },
                ...
                React.createElement(Select, { variant: "standard", error: !!error, disabled: !!disabled, value: this.state.value || '_', renderValue: () => (React.createElement(React.Fragment, null,
                    ...
                    React.createElement(ListItemIcon, null, this.getFileIcon(it)),
                    React.createElement(ListItemText, null, it.label),
                    this.props.schema.delete && item.value ? (React.createElement(IconButton, { style: styles.deleteButton, size: "small", onClick: () => this.setState({ deleteFile: item.value }) },
        ...
        return (React.createElement(Dropzone, { ref: this.dropzoneRef, multiple: false, accept: accept, noKeyboard: true, noClick: true, maxSize: this.props.schema.maxSize || 2 * 1024 * 1024, onDragEnter: () => {
            ...
            this.state.uploadFile === 'dragging' ? (React.createElement("div", { style: {
