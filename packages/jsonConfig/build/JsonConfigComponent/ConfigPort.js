...
class ConfigPort extends ConfigGeneric {
    ...
    renderItem(error, disabled) {
        ...
        return (React.createElement(TextField, { variant: "standard", type: "number", fullWidth: true, slotProps: {
            ...
            }, value: this.state._value === null || this.state._value === undefined ? '' : this.state._value, error: !!error, disabled: !!disabled, sx: warning ? styles.warning : undefined, onChange: e => {
