...
import { Button, CircularProgress, Dialog, DialogContent, DialogActions, DialogTitle, Table, TableHead, TableCell, TableRow, TableBody, DialogContentText, TableContainer, Box, } from '@mui/material';
...
class ConfigCheckLicense extends ConfigGeneric {
    ...
    renderErrorDialog() {
        if (this.state._error && !this.state.showLicenseData) {
            ...
            if (this.state.allLicenses) {
                content = [React.createElement("div", { key: "error" }, content)];
                    ...
                    content.push(React.createElement(TableContainer, { key: "table" },
                        React.createElement(Table, { size: "small" },
                            ...
                            React.createElement(TableBody, null, this.state.allLicenses.map(license => (React.createElement(TableRow, { key: license.id },
                                React.createElement(TableCell, { sx: license.validName ? null : styles.errorText }, license.license.product),
                                React.createElement(TableCell, { sx: license.validVersion ? null : styles.errorText }, license.license.version),
                                React.createElement(TableCell, { sx: license.validUuid ? null : styles.errorText }, license.license.uuid || '--'),
                                React.createElement(TableCell, { sx: license.validTill ? null : styles.errorText }, license.license.validTill &&
                                    license.license.validTill !== '0000-00-00 00:00:00'
                                    ? new Date(license.license.validTill).toLocaleDateString()
                                    : '--'),
                                React.createElement(TableCell, null, license.license.invoice !== 'free'
            ...
            return (React.createElement(Dialog, { open: !0, maxWidth: "xl", fullWidth: this.props.fullWidth !== undefined ? this.props.fullWidth : true, onClick: () => this.setState({ _error: '', allLicenses: null }) },
        ...
        if (this.state.showLicenseData) {
                        ...
                        if (obj[key1] !== null && obj[key1] !== undefined) {
                            if (typeof obj[key1] === 'object') {
                                pre.push(React.createElement("div", { key: key1 },
                                    React.createElement("div", { style: styles.licLabel },
                                        key1,
                                        ":"),
            ...
            return (React.createElement(Dialog, { open: !0, onClose: () => this.setState({ showLicenseData: null }) },
                React.createElement(DialogTitle, null,
                    React.createElement(Box, { component: "span", sx: this.state.result ? styles.okTitle : styles.errorTitle }, I18n.t('ra_License %s', this.state.result ? 'OK' : 'INVALID'))),
                React.createElement(DialogContent, null,
                    ...
                    this.state._error ? (React.createElement(Box, { component: "div", sx: styles.errorText }, this.state._error)) : null,
                    pre),
                React.createElement(DialogActions, null,
    ...
    renderAskForUpdate() {
        ...
        return (React.createElement(DialogConfirm, { text: I18n.t('ra_License not found in license manager. Do you want to read licenses from iobroker.net?'), ok: I18n.t('ra_Yes'), onClose: async (isYes) => {
                if (isYes) {
    ...
    renderItem( /* error, disabled, defaultValue */) {
        return (React.createElement("div", { style: styles.fullWidth },
            React.createElement(Button, { variant: this.props.schema.variant || 'outlined', color: this.props.schema.color || 'primary', style: styles.fullWidth, disabled: (!this.props.data.license && !this.props.data.useLicenseManager) || this.state.running, startIcon: React.createElement(IconSend, null), onClick: () => this._onClick() },
