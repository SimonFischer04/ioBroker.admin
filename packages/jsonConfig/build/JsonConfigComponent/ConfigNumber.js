...
class ConfigNumber extends ConfigGeneric {
    ...
    renderItem(error, disabled) {
        ...
        if (isIndeterminate) {
            ...
            return (React.createElement(Autocomplete, { style: styles.indeterminate, fullWidth: true, freeSolo: true, value: arr[0], 
                ...
                }, options: arr, getOptionLabel: (option) => option.label, renderInput: params => (React.createElement(TextField, { ...params, label: this.getText(this.props.schema.label), variant: "standard", slotProps: {
                        htmlInput: {
                            ...params.inputProps,
        ...
        return (React.createElement(FormControl, { variant: "standard", style: styles.control },
