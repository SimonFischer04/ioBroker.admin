...
class ConfigCoordinates extends ConfigGeneric {
    ...
    renderItem(error, disabled /* , defaultValue */) {
        return (React.createElement(React.Fragment, null,
            ...
            !this.props.schema.longitudeName || !this.props.schema.latitudeName ? (React.createElement(TextField, { variant: "standard", style: styles.width, value: this.state.value === null || this.state.value === undefined ? '' : this.state.value, error: !!error, disabled: !!disabled, slotProps: {
                    htmlInput: {
