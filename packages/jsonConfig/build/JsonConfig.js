...
import { I18n, Router, SaveCloseButtons, Theme, DialogConfirm, Utils, } from '@iobroker/adapter-react-v5';
...
class JsonConfig extends Router {
    ...
    async _getConfigFile(fileName, _filePaths) {
        ...
        try {
            ...
            try {
                // detect #include attr
                return (await this.scanForInclude(JSON5.parse(content), _filePaths));
            }
            catch (e) {
