...
export default function DeviceActionButton(props) {
    ...
    return (React.createElement(TooltipButton, { tooltip: tooltip || undefined, disabled: disabled || action.disabled, Icon: icon, onClick: deviceHandler(deviceId, action, refresh) }));
}
